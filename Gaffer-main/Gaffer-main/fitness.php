...
<body>
 <div class="topnav">
  ...
  <div class="topnav-right">
    ...
    <a href="/Users/sanz/Documents/Code/Project/login.html">Logout</a>
  </div>
</div>
...
<table id="customers" style="width:100%">
 <table>
        ...
        <th>Kit no</th>
             ...
             ?>
             <tr>
                 <td><label class="container"><?php echo $rows['playerid'];?></td>
               </label>
 ...
 <center><button class="button button7" onclick="validate2()" onclick="window.location.href = './physio.html';">Submit</button></center>
</div>
</body>
</html>